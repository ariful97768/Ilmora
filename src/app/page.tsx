...
import DynamicEnroll from "@/components/nav-enroll";

export default async function Home() {
  return (
    <>
      <div className="bg-[#0B2344]">
        ...
        <main className="text-white mx-auto">
          <section className="max-w-[1536px] mx-auto py-20 pt-16 relative z-10">
            <div className="max-w-[1050px] mx-auto space-y-3 pb-14">
              ...
              <p className="text-[#e7e8ee] text-center">
                A respected institution on research, teaching, <br /> and making
            ...
            <div className="flex gap-5 max-w-4xl mx-auto">
              <div className="space-y-3">
                ...
                <p className="text-[#d4d7e4] leading-5.5">
                  ...
                  excel. through challenging coursework and research, they
              ...
              <div className="space-y-3">
                ...
                <p className="text-[#d4d7e4] leading-5.5">
                  Postgraduate students at Ilmora engage in cutting-edge
                  research, working with top experts and resources. they deepen
                  their knowledge, contribute to innovative advancements, and
                  prepare for leadership roles in academia and industry. Ilmora
                  provides a collaborative environment for intellectual growth
                  and global impact.
                </p>
                <Link
                  href={"#"}
              ...
              <div className="max-w-7xl py-10 mx-auto flex flex-col items-center">
                <div className="flex py-5 items-center border-b-3 w-full justify-center gap-40">
                  ...
                  <div className="space-y-2 max-w-3xl">
                    ...
                    <p className="text-[#223043] leading-5.5">
                      Ilmora is home to some of the most prestigious libraries
                      in the world, offering students access to vast collections
                      of resources for research and study. Thee iconic
                      University Library, along with numerous departmental and
                      college libraries, provides an enriching environment for
                      academic pursuits.
                    </p>
                    <Link
                      href={"#"}
                ...
                <div className="flex py-5 items-center border-b-3 w-full justify-center gap-40">
                  ...
                  <div className="space-y-2 max-w-3xl">
                    ...
                    <p className="text-[#223043] leading-5.5">
                      The University boasts a number of renowned museums; such
                      as the Fitzwiliwam Museum and the Museum of Archeology and
                      Anthropology. These institutions offer students unique
                      opportunities to engage with history, art, and culture,
                ...
                <div className="flex py-5 items-center border-b-3 w-full justify-center gap-40">
                  ...
                  <div className="space-y-2 max-w-3xl">
                    ...
                    <p className="text-[#223043] leading-5.5">
                      ...
                      sutdents with places to relax, reflect, or engage in
                      outdoor activities. These areas contribute to a balanced
                      and healthy campus life.
                    </p>
                    <Link
                      href={"#"}
                      className="underline group text-sm flex items-center gap-2"
                ...
                <div className="flex py-5 items-center border-b-3 w-full justify-center gap-40">
                  ...
                  <div className="space-y-2 max-w-3xl">
                    ...
                    <p className="text-[#223043] leading-5.5">
                      Ilmora offers a wide range of sporting facilities and
                      clubs for students to stay active and pursue their
                      interest. From rowing on the River Cam to football and
                      tennis, there are numerous opportunities for students to
                      engage in physical activities and social events.
                    </p>
                    <Link
                      href={"#"}
                      className="underline group text-sm flex items-center gap-2"
          ...
          <section className="bg-white space-y-15 text-black pb-20">
            <div className="flex max-w-7xl gap-30 mx-auto">
              ...
              <p className="text-[#223043] tracking-wide leading-5.5">
                Studying at Ilmoa mean being parts of a tradition of
                intellectual curiosity and academic excellence. With access to
                world-class research, personalized supervision, and a vibrant
                student life, students are empowered to make meaningful
                contribution to their fields and beyond.
              </p>
            </div>
                    ...
                    <div className="overflow-hidden mx-5">
                      <div className="space-y-1 duration-600 translate-y-27 group-hover:-translate-y-0">
                        ...
                        <p className="leading-5 text-sm">
                          ...
                          elit. Illum quis explicabo rem alias totam vero, illo
                          in obcaecati vitae minus.
                        </p>
                        <Link
                          href={"#"}
              ...
              <div className="max-w-7xl mx-auto">
                <div className="max-w-2xl space-y-5 pt-10 pb-20 ">
                  ...
                  <p className="text-[#223043] tracking-wide leading-5.5">
                    ...
                    politics to entertainment and social activism. Below are
                    just a few of its many distinguished alumni.
                  </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[#223043] text-sm tracking-wide leading-5.5">
                      At Ilmora, undergraduates thrive in a dynamic academic
                      environment. With access to expert faculty,
                      state-of-the-art facilities, and a diverse community,
                      students are equipped to excel. through challenging
                      coursework and research, they develop critical thinking
                      and creativity, preparing for successful careers.
                    </p>
                    <Link
                      href={"#"}
